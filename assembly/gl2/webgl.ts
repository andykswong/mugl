...
import {
  Buffer, BindGroupLayout, BindGroup, Color, Device, Extent2D, Extent3D, Float, Future, GPU, MipmapHint,
  RenderPipeline, RenderPass, Sampler, Shader, Texture, UInt, UIntArray
} from '../gpu';
import {
 ...
 */
class WebGL2GPU implements GPU {
  /**
