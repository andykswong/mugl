 ...
 */
export type KHRTechniquesWebglGlTFExtension = KHRTechniquesWebglGlTFExtension1 & KHRTechniquesWebglGlTFExtension3;
export type KHRTechniquesWebglGlTFExtension1 = GlTFProperty & KHRTechniquesWebglGlTFExtension2;
/**
 * A shader program, including its vertex and fragment shaders.
 */
export type Program = GlTFChildOfRootProperty & Program1;
 ...
 */
export type Shader = Shader1 & Shader3;
export type Shader1 = GlTFChildOfRootProperty & Shader2;
export type Shader3 =
  | {
      [k: string]: unknown;
    }
