...
import { BufferDescriptor, TextureDescriptor, SamplerDescriptor, PipelineDescriptor, RenderPassDescriptor, Shader, ShaderDescriptor } from '../../common/device';
 ...
 */
export declare const GL1Feature: {
 ...
 */
export declare type GL1Feature = ValueOf<typeof GL1Feature>;
/**
 * WebGL2 features used by mugl.
 */
export declare const GL2Feature: {
    readonly Aniso: string;
    readonly TexFP16Lin: string;
    readonly TexFPLin: string;
 ...
 * WebGL2 features used by mugl.
 */
export declare type GL2Feature = ValueOf<typeof GL2Feature>;
/**
